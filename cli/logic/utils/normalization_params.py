...
def cli_normalization_params(dataset_name: str) -> None:
    """
    Print the normalization parameters for a specified dataset.

    Args:
        dataset_name (str): The name of the dataset. If the dataset is not supported, an error is raised. If no dataset is provided, all available datasets are listed
