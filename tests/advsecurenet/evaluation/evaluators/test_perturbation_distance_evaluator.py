...
def test_calculate_l0_distance(evaluator):
    ...
    l0_distance = evaluator.calculate_l0_distance(original_images, adversarial_images)
...
def test_calculate_l2_distance(evaluator):
    ...
    l2_distance = evaluator.calculate_l2_distance(original_images, adversarial_images)
...
def test_calculate_perturbation_distances(evaluator):
    ...
    l0_distance, l2_distance, l_inf_distance = (
        evaluator.calculate_perturbation_distances(original_images, adversarial_images)
    )
