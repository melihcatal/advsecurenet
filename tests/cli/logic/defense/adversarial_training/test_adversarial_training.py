...
@patch(
    "cli.logic.defense.adversarial_training.adversarial_training_cli.load_and_instantiate_config"
)
def test_atcli_trainer_init(
    mock_load_and_instantiate_config, mock_create_model, mock_prepare_dataset
):
...
def test_atcli_trainer_prepare_attacks(
    mock_load_and_instantiate_config, mock_prepare_dataset
):
    mock_config = MagicMock()
    ...
    mock_load_and_instantiate_config.return_value = MagicMock(spec=AttackConfig)
    ...
    attack_class.assert_called_once_with(mock_load_and_instantiate_config.return_value)
...
def test_atcli_trainer_prepare_models(
    mock_load_and_instantiate_config, mock_create_model, mock_prepare_dataset
):
    mock_config = MagicMock()
    ...
    mock_load_and_instantiate_config.return_value = MagicMock(spec=ModelCliConfigType)
...
@pytest.mark.essential
@patch(
    "cli.logic.defense.adversarial_training.adversarial_training_cli.DDPAdversarialTraining"
)
@patch(
    "cli.logic.defense.adversarial_training.adversarial_training_cli.load_and_instantiate_config"
)
@patch("cli.logic.defense.adversarial_training.adversarial_training_cli.create_model")
def test_atcli_trainer_ddp_training_fn(
    mock_create_model,
    mock_load_and_instantiate_config,
    mock_ddp_adversarial_training,
    ...
    mock_ddp_adversarial_training.assert_called_once_with(mock_training_env, 0, 2)
...
@pytest.mark.essential
@patch(
    "cli.logic.defense.adversarial_training.adversarial_training_cli.AdversarialTraining"
)
@patch(
    "cli.logic.defense.adversarial_training.adversarial_training_cli.load_and_instantiate_config"
)
@patch("cli.logic.defense.adversarial_training.adversarial_training_cli.create_model")
def test_atcli_trainer_execute_training(
    mock_create_model,
    mock_load_and_instantiate_config,
    mock_adversarial_training,
    mock_prepare_dataset,
):
    mock_config = MagicMock()
    mock_training_env = MagicMock()
